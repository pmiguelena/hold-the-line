...
G.en = {
  map: {
    ...
    layers: { prices: "Prices", activity: "Activity", jobs: "Jobs", credit: "Credit", public: "Public finances" },
    ...
    pub: { gov: "Public debt", shops: "Budget deficit", finance: "Risk premium", housing: "Mortgage rate" },
    ...
    legend: {
      ...
      public: [["good", "comfortable"], ["warn", "getting expensive"], ["bad", "the Treasury is squeezed"]]
    },
  ...
  qt: { label: "Bond holdings", off: ["Hold them", "let the portfolio run"], on: ["Sell some", "drain the money you created"],
    tip: v => `The Bank still holds ${v} rounds of bond purchases. Selling raises long rates, cools demand and shows the Treasury it cannot count on you.` },
  groups: { title: "Who felt it", savers: "Savers", borrowers: "Borrowers", workers: "Workers", retirees: "Retirees",
    tip: "Every decision helps some households and hurts others. When a group turns really angry, the street does too, and the government looks for someone to blame." },
  whyExtra: { presser: "Press conference answer", qe: "Large asset purchases with inflation high", qt: "Selling bonds back into the market", dominance: "Debt so high that people expect it to be inflated away", outvoted: "Outvoted by your own board", divided: "A divided board (3–2)", united: "A united board", macro: "Stricter mortgage rules annoy buyers", lastReserves: "Spending the last of the reserves" },
  ...
  mkt: { fx: "Currency (LC/US$)", y10: "10-year yield", stocks: "Stock index" },
  ...
  hud: { infl: "Inflation", gap: "Output gap", rate: "Policy rate", cred: "Credibility", pop: "Popularity", charts: "Charts", menu: "Pause", jobs: "Unemployment", heat: "Removal risk", stocks: "Stock index", world: "world", y10: "10-year", reserves: "Reserves", months: "months", debt: "Public debt", fx: "Exchange rate", fxUnit: "LC per US$1", fxTip: "How much local money one US dollar buys. A bigger number means a weaker currency." },
  chartsTitle: "Economic monitor", close: "Close",
  chart: { infl: "Inflation", gap: "Output gap", rate: "Policy rate", pol: "Credibility & popularity", exp: "expected", cred: "credibility", pop: "popularity", target: "target", heat: "removal risk", mkt: "Stocks and currency", eq: "stocks", fx: "local currency per US$1", y10: "10-year yield", first: "first estimate", world: "world rate", fin: "Credit gap and reserves", lev: "credit gap, points", resv: "reserves, months", fisc: "Public debt", debt: "debt, % of GDP", interest: "interest bill, % of GDP" },
...
G.es = {
  map: {
    ...
    layers: { prices: "Precios", activity: "Actividad", jobs: "Empleo", credit: "Crédito", public: "Cuentas públicas" },
    ...
    pub: { gov: "Deuda pública", shops: "Déficit fiscal", finance: "Prima de riesgo", housing: "Tasa hipotecaria" },
    ...
    legend: {
      ...
      public: [["good", "cómodas"], ["warn", "se encarecen"], ["bad", "el Tesoro está ahogado"]]
    },
  ...
  qt: { label: "Cartera de bonos", off: ["Mantenerla", "dejar correr la cartera"], on: ["Vender parte", "retirar el dinero que creaste"],
    tip: v => `El Banco todavía tiene ${v} rondas de compras de bonos. Venderlas sube las tasas largas, enfría la demanda y le muestra al Tesoro que no puede contar contigo.` },
  groups: { title: "Quién lo sintió", savers: "Ahorristas", borrowers: "Deudores", workers: "Trabajadores", retirees: "Jubilados",
    tip: "Cada decisión ayuda a unos hogares y perjudica a otros. Cuando un grupo se enoja de verdad, la calle también, y el gobierno busca a quién culpar." },
  whyExtra: { presser: "Respuesta en la conferencia de prensa", qe: "Compras masivas de activos con inflación alta", qt: "Vender bonos de vuelta al mercado", dominance: "Deuda tan alta que la gente espera que se licue con inflación", outvoted: "Tu propio directorio te derrotó", divided: "Un directorio dividido (3–2)", united: "Un directorio unido", macro: "Las reglas hipotecarias estrictas molestan a los compradores", lastReserves: "Gastar las últimas reservas" },
  ...
  mkt: { fx: "Moneda (ML/US$)", y10: "Bono a 10 años", stocks: "Índice bursátil" },
  ...
  hud: { infl: "Inflación", gap: "Brecha", rate: "Tasa", cred: "Credibilidad", pop: "Popularidad", charts: "Gráficos", menu: "Pausa", jobs: "Desempleo", heat: "Riesgo de destitución", stocks: "Bolsa", world: "mundo", y10: "10 años", reserves: "Reservas", months: "meses", debt: "Deuda pública", fx: "Tipo de cambio", fxUnit: "ML por US$1", fxTip: "Cuánta moneda local compra un dólar. Un número más alto significa una moneda más débil." },
  chartsTitle: "Monitor económico", close: "Cerrar",
  chart: { infl: "Inflación", gap: "Brecha del producto", rate: "Tasa de política", pol: "Credibilidad y popularidad", exp: "esperada", cred: "credibilidad", pop: "popularidad", target: "meta", heat: "riesgo de destitución", mkt: "Bolsa y moneda", eq: "bolsa", fx: "moneda local por US$1", y10: "bono a 10 años", first: "primera estimación", world: "tasa mundial", fin: "Brecha de crédito y reservas", lev: "brecha de crédito, puntos", resv: "reservas, meses", fisc: "Deuda pública", debt: "deuda, % del PIB", interest: "intereses, % del PIB" },
